...
def createDataset(outputPath, img_dir, imagePathList, labelList, lexiconList=None, checkValid=True):
    """
    ...
    for i in range(nSamples):
        ...
        imagePath = os.path.join(img_dir, imagePath)
        label = labelList[i]
...
if __name__ == '__main__':
    ...
    if args.file is not None:
        ...
        createDataset(args.out, os.path.dirname(args.file), image_path_list, label_list)
